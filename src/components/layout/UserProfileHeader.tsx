...
export default function UserProfileHeader() {
  ...
  return (
    <div className={cn( 
      ...
      <SoundEffect src={SOUND_EFFECTS.NOTIFICATION} play={playNotificationSound} onEnd={() => setPlayNotificationSound(false)} volume={0.3} />
      ...
      <div className="container relative flex h-14 max-w-screen-2xl items-center justify-between px-3 sm:px-4">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          >
            <Plus className={cn("h-4 w-4 transition-transform duration-300", showQuickActions && "rotate-45")} />
          </Button>
        ...
        <AnimatePresence>
          {showQuickActions && (
            ...
            >
              <Card className="bg-background/95 backdrop-blur-xl border-primary/20 shadow-xl p-3 min-w-48">
                <div className="space-y-2">
                  <h3 className="text-sm font-semibold text-primary">Ações Rápidas</h3>
