...
export function Shimmer({ className, duration = 2000, delay = 0 }: ShimmerProps) {
  return (
    <motion.div
      className={cn(
...
export function Pulse({ className, duration = 2000, scale = 1.05 }: PulseProps) {
  return (
    <motion.div
...
export function GlowEffect({
  ...
  return (
    <motion.div
      className={cn(`absolute inset-0 rounded-full bg-${color}`, className)}
      animate={{
        boxShadow: [
...
export function PopEffect({ className, scale = 1.1, duration = 200 }: PopEffectProps) {
  return (
    <motion.div
      className={cn('', className)}
      whileHover={{
...
export function RotatingEffect({ className, degrees = 360, duration = 3000 }: RotatingEffectProps) {
  return (
    <motion.div
      className={cn('', className)}
      animate={{
