...
import {
  ...
  Eye, Flag, Settings, RefreshCw, Filter,
  MessageSquare, Image as ImageIcon, Users,
  AlertOctagon, Clock, BarChart2, FileText,
  Save, Download, Share2
} from 'lucide-react';
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Sistema automático de moderação com IA
              </CardDescription>
            </div>
            ...
            <TabsContent value="overview" className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      <div className="p-2 rounded-full bg-red-500/10 w-12 h-12 mx-auto mb-2 flex items-center justify-center">
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      <div className="p-2 rounded-full bg-yellow-500/10 w-12 h-12 mx-auto mb-2 flex items-center justify-center">
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            <div className={cn(
                              "p-2 rounded-full",
                              content.status === 'approved' ? "bg-green-500/10" :
                              content.status === 'rejected' ? "bg-red-500/10" :
                              "bg-yellow-500/10"
                            )}>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Slider
                              ...
                              step={1}
                              onValueChange={([value]) =>
                                handleSettingsChange(setting.id, 'sensitivity', value)
                              }
                            />
                          </div>
                          <div className="flex items-center gap-2">
            ...
            <TabsContent value="reports" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Análise detalhada das ações de moderação
                  </CardDescription>
                </CardHeader>
                <CardContent>
