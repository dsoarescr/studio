...
const mockPersonalAnalytics: PersonalAnalytics = {
  ...
  activeHours: [
    0, 2, 5, 12, 18, 25, 30, 45, 38, 28, 15, 8, 12, 20, 35, 40, 45, 38, 25, 15, 8, 5, 2, 1,
  ],
            ...
            <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-blue-700">
                  {personalAnalytics.postsCreated}
                </div>
            ...
            <Card className="border-red-200 bg-gradient-to-br from-red-50 to-red-100">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-red-700">
                  {personalAnalytics.likesReceived}
                </div>
            ...
            <Card className="border-green-200 bg-gradient-to-br from-green-50 to-green-100">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-green-700">
                  {personalAnalytics.followersGained}
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-green-600">
                    {personalAnalytics.engagementRate}%
                  </span>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="rounded-lg border border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50 p-4">
                <h3 className="mb-2 text-lg font-semibold">{personalAnalytics.topPost.title}</h3>
              ...
              <div className="flex flex-wrap gap-2">
                {personalAnalytics.topTopics.map((topic, index) => (
                  <Badge
                    ...
                    className={cn(
                      'text-sm',
                      index === 0 && 'border-purple-200 bg-purple-100 text-purple-700'
                    )}
                  >
                    {topic}
                  </Badge>
            ...
            <Card className="border-green-200 bg-gradient-to-br from-green-50 to-green-100">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-green-700">
                  Sua taxa de engajamento está 15% acima da média! Continue criando conteúdo de
                  qualidade.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-blue-700">
                  Posts às 18:00 recebem 40% mais engajamento. Considere postar neste horário.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-purple-200 bg-gradient-to-br from-purple-50 to-purple-100">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-purple-700">
                  Conteúdo sobre "Tutorial" tem alta demanda. Crie mais tutoriais para aumentar o
                  alcance.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-orange-200 bg-gradient-to-br from-orange-50 to-orange-100">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-orange-700">
                  Você está conectado com 67% dos top contribuidores. Expanda sua rede para maior
                  visibilidade.
                </p>
              </CardContent>
            </Card>
