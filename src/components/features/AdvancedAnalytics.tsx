  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="text-gradient-gold font-headline text-3xl font-bold">
            Analytics Avançados
          </h1>
          ...
          <CardContent className="p-4">
            <div className="mb-2 flex items-center justify-between">
              ...
              <Badge variant="outline" className={getTrendColor(analyticsData.likes.trend)}>
                {analyticsData.likes.trend === 'up' ? '+' : ''}
                {analyticsData.likes.change}%
              </Badge>
            </div>
          ...
          <CardContent className="p-4">
            <div className="mb-2 flex items-center justify-between">
              ...
              <Badge variant="outline" className={getTrendColor(analyticsData.shares.trend)}>
                {analyticsData.shares.trend === 'up' ? '+' : ''}
                {analyticsData.shares.change}%
              </Badge>
            </div>
          ...
          <CardContent className="p-4">
            <div className="mb-2 flex items-center justify-between">
              ...
              <Badge variant="outline" className={getTrendColor(analyticsData.engagement.trend)}>
                {analyticsData.engagement.trend === 'up' ? '+' : ''}
                ...
                <div className="space-y-3">
                  {regionalData.map(region => (
                    <div key={region.region} className="space-y-2">
                      ...
                      <Progress value={(region.revenue / 1000) * 100} className="h-2" />
                    </div>
                  ))}
                </div>
              </CardContent>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 text-sm text-muted-foreground">
                          ...
                          <span className="flex items-center gap-1">
                            <DollarSign className="h-3 w-3" />€{pixel.revenue}
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                {[
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        <h4 className="text-sm font-medium">{rec.type}</h4>
